      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-white p-4 rounded-3xl border border-slate-100 shadow-sm">
        <div className="relative w-full md:max-w-md">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-2.5 bg-slate-50 border border-slate-200 focus:border-purple-500 focus:bg-white focus:ring-2 focus:ring-purple-100 rounded-2xl text-sm font-medium transition-all outline-none"
          />
        </div>
      ...
      {subTab === "directorio" ? (
        <div className="space-y-4">
          {selectedCustomerCedulas.length > 0 && (
            <div className="bg-purple-50 border border-purple-100 rounded-3xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4 animate-fade-in shadow-sm">
              <div className="flex items-center space-x-3">
                <div className="h-9 w-9 bg-purple-600 text-white rounded-full flex items-center justify-center font-black text-sm">
              ...
              <div className="flex space-x-2 w-full sm:w-auto">
                <button
                  ...
                  className="flex-1 sm:flex-initial flex items-center justify-center space-x-1.5 px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs uppercase tracking-wider rounded-xl transition-all shadow-sm"
                >
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="p-4 flex items-center space-x-3">
                            <div className="h-10 w-10 rounded-full bg-purple-50 text-purple-700 flex items-center justify-center font-black">
                              {c.name.charAt(0).toUpperCase()}
                            </div>
                            <div>
                              <p className="font-extrabold text-slate-800 group-hover:text-purple-600 transition-colors">{c.name}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-white p-6 rounded-3xl border border-slate-100 shadow-sm space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-1.5 bg-slate-50 p-1.5 rounded-2xl border border-slate-100">
                <button
                  ...
                  className="p-2 hover:bg-white hover:shadow-sm text-slate-600 hover:text-purple-600 rounded-xl transition-all cursor-pointer"
                  title="Mes Anterior"
                >
                ...
                <button
                  ...
                  className="px-3 py-1 bg-white border border-slate-100 rounded-xl text-[10px] font-extrabold uppercase tracking-wider text-slate-600 hover:text-purple-600 shadow-sm transition-all cursor-pointer"
                >
                  Hoy
                </button>
                <button
              ...
              <div className="grid grid-cols-7 gap-2">
                {calendarCells.map((cell, idx) => {
                  ...
                  if (hasCollection) {
                    ...
                    if (isSelected) {
                      cellStyle += "bg-purple-600 text-white font-black shadow-md shadow-purple-200 ring-2 ring-offset-2 ring-purple-500 scale-[1.03] z-10";
                    } else if (isToday) {
                  ...
                  const searchRing = (searchTerm && matchesSearch) ? "ring-2 ring-purple-500 ring-offset-1" : "";
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Today dot indicator */}
                      {isToday && !isSelected && (
                        <span className="absolute top-1.5 right-1.5 h-1.5 w-1.5 bg-purple-600 rounded-full" />
                      )}
                    </div>
                  );
                })}
            ...
            <div className="pt-4 border-t border-slate-100 flex flex-wrap items-center gap-4 text-[10px] font-bold uppercase text-slate-400 tracking-wider">
              ...
              <span className="flex items-center space-x-1.5">
                <span className="h-3.5 w-3.5 rounded-lg bg-purple-600 block" />
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-slate-900 text-white p-6 rounded-3xl border border-slate-800 shadow-xl space-y-4">
              <div className="flex items-center space-x-3">
                <div className="p-2.5 bg-slate-800 text-purple-400 rounded-2xl border border-slate-700">
                    ...
                    >
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex items-start space-x-3">
                          <div className="h-10 w-10 rounded-2xl bg-purple-50 text-purple-700 flex items-center justify-center font-black flex-shrink-0 text-sm">
                      ...
                      <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-100 space-y-2 text-xs">
                        ...
                        {hasMultipleCuotas && (
                          <div className="flex justify-between items-center text-[10px] bg-purple-50 border border-purple-100 p-2 rounded-xl text-purple-700 font-extrabold uppercase tracking-wide">
                            <span>Plan: Cuotas Recurrentes</span>
                            <span className="bg-purple-600 text-white px-2 py-0.5 rounded-lg text-[9px]">
                      ...
                      <div className="flex items-center justify-between gap-2 pt-2 border-t border-slate-50">
                        ...
                        <div className="flex space-x-2">
                          ...
                          <button
                            ...
                            className="flex items-center space-x-1 px-3 py-2 bg-purple-600 hover:bg-purple-500 text-white font-extrabold text-xs uppercase tracking-wider rounded-xl transition-all shadow-sm cursor-pointer"
                          >
          ...
          <div className="bg-white h-full w-full max-w-2xl shadow-2xl flex flex-col border-l border-slate-100 animate-slide-in">
            ...
            <div className="p-6 border-b border-slate-100 flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <div className="h-12 w-12 rounded-2xl bg-purple-100 text-purple-700 flex items-center justify-center text-lg font-black">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-3xl p-4 flex items-center justify-between gap-4 animate-fade-in">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex items-center space-x-1 px-3 py-2 bg-white hover:bg-purple-50 text-purple-700 hover:text-purple-600 border border-purple-200 rounded-xl text-xs font-bold transition-all shadow-sm"
                  >
                        ...
                        <div className="flex justify-between items-start">
                          ...
                          <div className="text-right flex flex-col items-end">
                            ...
                            {sale.paymentPeriodicity && rAmt > 0 && (
                              <span className="text-[10px] text-purple-600 font-extrabold mt-1 uppercase">
                          ...
                          <div className="flex items-center space-x-1.5">
                            ...
                            {rAmt > 0 && (
                              <button
                                ...
                                className="px-3 py-1.5 bg-purple-100 hover:bg-purple-600 text-purple-700 hover:text-white font-extrabold text-[10px] uppercase tracking-wider rounded-xl transition-all shadow-sm"
                              >
                                Registrar Abono
                              </button>
                            )}
              ...
              <div className="space-y-3.5">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full p-2.5 bg-slate-50 border border-slate-200 focus:border-purple-500 focus:bg-white focus:ring-2 focus:ring-purple-200 rounded-xl text-xs font-semibold outline-none"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full p-2.5 bg-slate-50 border border-slate-200 focus:border-purple-500 focus:bg-white focus:ring-2 focus:ring-purple-200 rounded-xl text-xs font-semibold outline-none resize-none"
                  />
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl w-full max-w-5xl p-6 shadow-2xl relative border border-slate-100 space-y-6 animate-fade-in my-8 max-h-[90vh] flex flex-col animate-fade-in">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-1 bg-purple-600 hover:bg-purple-500 text-white font-extrabold text-[10px] uppercase rounded-lg"
                  >
                    Aplicar
                  </button>
                </div>
                      ...
                      <tr key={idx} className="hover:bg-slate-50/50">
                        <td className="p-2">
                          <input
                            ...
                            className="w-full p-1.5 bg-slate-50 border border-transparent focus:border-purple-300 focus:bg-white rounded outline-none font-bold text-slate-800"
                          />
                        </td>
                        <td className="p-2">
                          <input
                            ...
                            className="w-full p-1.5 bg-slate-50 border border-transparent focus:border-purple-300 focus:bg-white rounded outline-none font-mono text-slate-600"
                          />
                        </td>
                        <td className="p-2">
                          <input
                            ...
                            className="w-full p-1.5 bg-slate-50 border border-transparent focus:border-purple-300 focus:bg-white rounded outline-none text-slate-600"
                          />
                        </td>
                        <td className="p-2">
                          <input
            ...
            <div className="flex justify-end space-x-2 pt-4 border-t border-slate-100 flex-shrink-0">
              ...
              <button
                ...
                className="px-6 py-2 bg-purple-600 hover:bg-purple-500 disabled:bg-purple-300 text-white text-xs font-extrabold uppercase tracking-wider rounded-xl shadow-md flex items-center space-x-2"
              >
                {isSavingBulkEdit ? (
                  <>
                    <div className="h-3.5 w-3.5 border-2 border-white border-t-transparent rounded-full animate-spin" />
