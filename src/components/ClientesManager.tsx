...
import {
  ...
  ChevronLeft, ChevronRight, Download, Plus, Heart, Sparkles
} from "lucide-react";
  ...
  const handleShareWhatsApp = (sale: Sale) => {
    ...
    const mensajeCobro = isPending
      ? `\n\n📢 *MENSAJE DE COBRANZA - MONTO PENDIENTE*\n` +
        `Estimado(a) *${sale.customerName}*, le recordamos que posee un *saldo pendiente por pagar de $${(sale.remainingAmount || 0).toLocaleString()}* ` +
