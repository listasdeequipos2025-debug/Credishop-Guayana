              ...
              <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="Ej: Receta 100% sin alérgenos ni trazas de gluten"
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-md p-4 sm:p-6 relative shadow-2xl my-auto max-h-[92vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                >
                  <option value={ProductCategory.Equipos}>Equipos / Productos Principales</option>
                  <option value={ProductCategory.Accesorios}>Accesorios / Complementos</option>
                </select>
              </div>
