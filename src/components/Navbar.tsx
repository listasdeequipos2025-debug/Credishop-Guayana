    ...
    <header className="bg-gradient-to-r from-emerald-950 via-slate-900 to-amber-950 text-white shadow-xl sticky top-0 z-50 border-b border-emerald-800/40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          {/* Logo and Brand */}
          <div className="flex items-center space-x-3 cursor-pointer group" onClick={() => setActiveTab("catalogo")}>
            <div className="relative h-14 w-14 rounded-2xl p-1 bg-white shadow-xl border border-amber-400/40 flex-shrink-0 group-hover:scale-105 transition-transform">
              <img
                src={logoImg}
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-orange-200 to-emerald-300">
                SinGlutenpzo
              </h1>
