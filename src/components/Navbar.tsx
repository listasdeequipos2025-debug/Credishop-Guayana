...
export default function Navbar({
  ...
  return (
    <header className="bg-gradient-to-r from-blue-950 via-slate-900 to-blue-950 text-white shadow-xl sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          {/* Logo and Brand */}
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => setActiveTab("catalogo")}>
            <div className="relative h-12 w-12 rounded-xl overflow-hidden shadow-lg border border-blue-400/30 bg-blue-950 flex-shrink-0">
              <img
                src={logoImg}
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-black tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-sky-200">
                CREDISHOP GUAYANA
              </h1>
