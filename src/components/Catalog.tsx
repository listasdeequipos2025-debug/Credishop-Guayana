    ...
    <div className="space-y-8 animate-fade-in relative">
      ...
      {cart.length > 0 && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 bg-purple-600 hover:bg-purple-500 text-white p-4 rounded-full shadow-2xl flex items-center justify-center space-x-2 transition-all hover:scale-105 border-2 border-white animate-bounce"
        >
          <ShoppingCart className="h-6 w-6" />
          <span className="bg-white text-purple-700 text-xs font-black h-5 w-5 rounded-full flex items-center justify-center shadow-inner">
            {cartItemsCount}
          </span>
        </button>
      )}
      ...
      <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-purple-900 to-indigo-900 text-white p-8 sm:p-12 shadow-xl border border-purple-500/10">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="max-w-xl space-y-4">
            <span className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-purple-500/20 border border-purple-400/30 text-xs font-bold uppercase tracking-wider text-purple-300">
              <span>Catálogo Oficial</span>
            </span>
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight leading-none">
              <span className="text-purple-300">CREDISHOP GUAYANA</span>
            </h2>
          ...
          <div className="flex-shrink-0 self-center md:self-auto">
            <img
              ...
              className="w-32 h-32 rounded-2xl object-cover shadow-2xl border-2 border-purple-400/30"
      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-white p-4 rounded-2xl shadow-sm border border-slate-100">
        <div className="relative w-full md:max-w-md">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 focus:border-purple-500 focus:bg-white focus:ring-2 focus:ring-purple-200 rounded-xl text-sm font-medium transition-all outline-none"
          />
        </div>
      ...
      {categoryFilter === "equipos" && availableBrands.length > 0 && (
        <div className="bg-gradient-to-r from-slate-50 to-indigo-50/20 border border-slate-200/50 p-6 rounded-3xl space-y-4 animate-fade-in shadow-sm">
          <div className="flex items-center justify-between">
            ...
            {selectedBrand !== "all" && (
              <button
                ...
                className="text-[10px] font-bold uppercase tracking-wider text-purple-600 hover:text-purple-800 transition-colors"
              >
                Limpiar Filtro ×
              </button>
            )}
              ...
              return (
                <button
                  ...
                  className={`flex-shrink-0 flex items-center space-x-3 px-5 py-3 rounded-2xl text-xs font-bold transition-all duration-300 border focus:outline-none ${
                    isSelected
                      ? "bg-gradient-to-r from-indigo-600 to-purple-600 text-white border-transparent shadow-lg shadow-indigo-500/20 scale-[1.03] -translate-y-0.5"
                ...
                >
                  <span className={`w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black uppercase transition-all shadow-inner ${
                    isSelected 
                      ...
                      : "bg-gradient-to-br from-purple-50 to-indigo-50 text-purple-600 border border-purple-100"
                  }`}>
            ...
            return (
              <div key={brandName} className="space-y-4 animate-fade-in">
                ...
                <div className="flex items-center space-x-2.5 border-b border-slate-200 pb-2">
                  <div className="h-2.5 w-2.5 rounded-full bg-purple-600 animate-pulse" />
                    ...
                    >
                      <div>
                        ...
                        {product.image ? (
                          ...
                          <div className="p-1 bg-gradient-to-r from-purple-100 to-indigo-50 border-b border-slate-100/50" />
                        )}
                        ...
                        <div className="p-6 space-y-4">
                          ...
                          <div className="flex items-end justify-between pt-2">
                            <div className="flex flex-col">
                              ...
                              <span className="text-2xl font-black text-purple-950">${product.salePrice.toLocaleString()}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="p-6 pt-0 border-t border-slate-50 mt-auto">
                        <button
                          ...
                          className="w-full flex items-center justify-center space-x-2 py-3 bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs uppercase tracking-wider rounded-2xl shadow-md hover:shadow-purple-500/25 transition-all"
                        >
              ...
              {cart.length === 0 ? (
                ...
                <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-center space-x-3.5 flex-1 min-w-0">
                        {item.product.image ? (
                          ...
                          <div className="h-12 w-12 rounded-xl bg-purple-50 text-purple-700 flex items-center justify-center font-bold flex-shrink-0">
                            P
                          </div>
                        )}
                  ...
                  <div className="p-4 bg-purple-50/50 rounded-2xl border border-purple-100/50 flex justify-between items-center">
                    <span className="text-xs font-extrabold text-purple-900 uppercase">Subtotal General:</span>
                    <span className="text-lg font-black text-purple-950">${cartTotal.toLocaleString()}</span>
                  </div>
                    ...
                    <div className="space-y-3">
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 focus:border-purple-500 focus:bg-white focus:ring-2 focus:ring-purple-100 rounded-xl text-xs font-medium transition-all outline-none"
                        />
                      </div>
                      ...
                      <div className="flex gap-2">
                        <select
                          ...
                          className="p-2.5 bg-slate-50 border border-slate-200 focus:border-purple-500 focus:bg-white focus:ring-2 focus:ring-purple-100 rounded-xl text-xs font-bold outline-none"
                        >
