...
export default function Catalog({ products, whatsappNumber }: CatalogProps) {
  ...
  return (
    <div className="space-y-8 animate-fade-in relative">
      ...
      <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-emerald-950 via-slate-900 to-amber-950 text-white p-8 sm:p-12 shadow-2xl border border-amber-500/20">
        <div 
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="max-w-xl space-y-4">
            <span className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-emerald-500/20 border border-emerald-400/30 text-xs font-bold uppercase tracking-wider text-emerald-300">
              <Wheat className="h-3.5 w-3.5" />
              <span>SinGlutenpzo • Oriven Distribuidora</span>
            </span>
            <h2 className="text-3xl sm:text-5xl font-black tracking-tight leading-none text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-orange-200 to-emerald-300">
              SinGlutenpzo
            </h2>
            <p className="text-sm sm:text-base text-amber-100/90 leading-relaxed">
              Explora nuestro catálogo en tiempo real de productos 100% libre de gluten, harinas alternativas, granos nutritivos y postres saludables hechos con pasión en Puerto Ordaz. ¡Haz tu pedido por WhatsApp con entrega rápida!
            </p>
          </div>
          <div className="flex-shrink-0 self-center md:self-auto">
            <div className="w-36 h-36 rounded-3xl bg-white p-3 shadow-2xl border-2 border-amber-400/40 transform hover:scale-105 transition-transform">
              <img
                src={logoImg}
