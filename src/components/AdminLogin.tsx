...
export default function AdminLogin({
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-[100] flex items-center justify-center p-4">
      <div className="bg-slate-900 border border-blue-900/40 rounded-3xl w-full max-w-sm p-6 shadow-2xl relative">
        <button
          onClick={onClose}
        ...
        <div className="flex flex-col items-center mb-6">
          <div className="relative w-16 h-16 rounded-2xl overflow-hidden shadow-xl border border-blue-500/30 mb-3 bg-blue-950 flex-shrink-0">
            <img
              src={logoImg}
