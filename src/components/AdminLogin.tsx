...
export default function AdminLogin({
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/85 backdrop-blur-md z-[100] flex items-center justify-center p-4">
      <div className="bg-slate-900 border border-blue-900/40 rounded-3xl w-full max-w-sm p-6 shadow-2xl relative overflow-hidden transition-all duration-300">
                    ...
                    <div className="space-y-4 pt-1 border-t border-slate-800/60">
                      <div className="bg-slate-950 border border-slate-800/80 p-3 rounded-xl space-y-1.5">
                        ...
                        <p className="text-xs font-bold text-slate-200">
                          {securityQuestion || "¿Cuál es tu marca de celulares favorita?"}
                        </p>
                      </div>
                    ...
                    <div className="space-y-4 pt-1 border-t border-slate-800/60">
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          ...
                          <input
                            type="email"
                            placeholder="Ej: admin@credishop.com"
