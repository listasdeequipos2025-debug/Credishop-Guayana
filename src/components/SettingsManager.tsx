...
export default function SettingsManager({
  ...
  const [questionVal, setQuestionVal] = useState(securityQuestion || "¿Cuál es tu marca de celulares favorita?");
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full p-3 bg-slate-50 border border-slate-200 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-100 rounded-xl text-sm font-semibold transition-all outline-none"
              >
                <option value="¿Cuál es tu marca de celulares favorita?">¿Cuál es tu marca de celulares favorita?</option>
                ...
                <option value="¿Cuál era el modelo de tu primer teléfono?">¿Cuál era el modelo de tu primer teléfono?</option>
              </select>
              <p className="text-[10px] text-slate-400 leading-snug">
