        ...
        <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 space-y-6">
          ...
          <form onSubmit={handleUpdatePinSubmit} className="space-y-4">
            ...
            <div className="flex justify-end pt-2">
              <button
                type="submit"
                className="w-full sm:w-auto px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-extrabold uppercase tracking-wider rounded-xl shadow-md transition-all"
              >
                Cambiar PIN
              </button>
            </div>
