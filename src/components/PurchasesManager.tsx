                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      ...
                      className="flex items-center space-x-1.5 px-6 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-extrabold uppercase tracking-wider rounded-xl shadow-md"
                    >
              ...
              {currency === "USD" ? (
                ...
                <div className="space-y-3">
                  ...
                  {originalAmountVES && bcvRate && !isNaN(parseFloat(originalAmountVES) / parseFloat(bcvRate)) && (
                    <div className="p-3 bg-indigo-50 border border-indigo-100 rounded-xl flex justify-between items-center text-xs font-bold text-indigo-900">
              ...
              <div className="space-y-1">
                ...
                {invoiceImage ? (
                  ...
                  <div
                    ...
                    className="border border-dashed border-slate-200 hover:border-purple-400 bg-slate-50 hover:bg-purple-50/10 p-4 rounded-2xl text-center cursor-pointer transition-all space-y-1"
                  >
                    <UploadCloud className="h-6 w-6 text-purple-400 mx-auto" />
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {p.invoiceImage && (
                        <button
                          ...
                          className="p-1 bg-purple-50 hover:bg-purple-100 text-purple-600 rounded-lg transition-all"
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="text-xs divide-y divide-slate-100">
                    {filteredProviders.map((p) => {
                      ...
                      return (
                        <tr key={p.id} className={`hover:bg-slate-50/50 transition-colors ${isSelected ? "bg-purple-50/30" : ""}`}>
                          ...
                          <td className="p-4 text-right">
                            <div className="flex items-center justify-end space-x-2">
                              <button
                                ...
                                className="p-2 bg-slate-50 hover:bg-purple-50 text-slate-500 hover:text-purple-600 rounded-xl transition-all"
          ...
          <div className="bg-white rounded-3xl max-w-2xl w-full p-6 shadow-2xl relative border border-slate-100 space-y-4">
            ...
            <div className="flex justify-end">
              <a
                ...
                className="px-5 py-2 bg-purple-600 hover:bg-purple-500 text-white text-xs font-bold uppercase tracking-wider rounded-xl transition-all shadow-md"
              >
                Descargar Imagen
              </a>
            </div>
          ...
          <div className="bg-white rounded-3xl w-full max-w-lg p-6 shadow-2xl relative border border-slate-100 space-y-6 animate-fade-in my-8">
            ...
            <form onSubmit={handleEditProviderSubmit} className="space-y-4">
              ...
              <div className="flex justify-end space-x-2 pt-2 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  className="px-6 py-2 bg-purple-600 hover:bg-purple-500 text-white text-xs font-extrabold uppercase tracking-wider rounded-xl shadow-md"
                >
                  Guardar Cambios
                </button>
              </div>
                      ...
                      <tr key={idx} className="hover:bg-slate-50/50">
                        ...
                        <td className="p-2">
                          <input
                            ...
                            className="w-full p-1.5 bg-slate-50 border border-transparent focus:border-purple-300 focus:bg-white rounded outline-none text-slate-600 italic"
                          />
                        </td>
                      </tr>
                    ))}
