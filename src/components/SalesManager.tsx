            ...
            <div className="border-2 border-slate-100 rounded-2xl p-5 space-y-4 bg-slate-50/50">
              <div className="flex flex-col items-center text-center space-y-2">
                <img
                  ...
                  className="w-12 h-12 rounded-xl object-cover shadow-sm border border-blue-100"
                  referrerPolicy="no-referrer"
                />
                <div className="space-y-1">
                  <h4 className="text-lg font-black text-blue-950 tracking-wider">CREDISHOP GUAYANA</h4>
                  <p className="text-[9px] font-bold uppercase tracking-[0.2em] text-blue-500">Celulares y Accesorios</p>
              ...
              <div className="text-center text-[10px] font-bold text-blue-500 pt-2 border-t border-dashed border-slate-200">
