...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-amber-50/40 text-slate-800 font-sans antialiased relative selection:bg-amber-500 selection:text-white">
      {/* Background image overlay matching social object */}
      <div 
        className="fixed inset-0 pointer-events-none opacity-[0.035] bg-repeat bg-center z-0"
        style={{ backgroundImage: `url(/src/assets/images/singlutenpzo_bg_1785767621918.jpg)` }}
      />
